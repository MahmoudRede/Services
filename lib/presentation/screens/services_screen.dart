              ...
              child: Container(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Text('- '+AppLocalizations.of(context)!.translate('addProduct').toString(),style: GoogleFonts.cairo(
                      fontSize: 18.0,
                      fontWeight: FontWeight.w500,
                      color: ColorManager.white,
                    ),),
                    Text('- My Services',style: GoogleFonts.cairo(
                      fontSize: 18.0,
                      fontWeight: FontWeight.w500,
                ...
                children: List.generate(cubit.servicesImages.length, (index) => GestureDetector(
                  onTap: (){
                    Navigator.push(context, MaterialPageRoute(builder: (_){
                      return AddProductScreen(categoryName:cubit.servicesTitles[index]);
                    }));
                  },
                  child: Container(
